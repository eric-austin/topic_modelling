...
for t in [0, 2]:
    ng_sentence_nb.save_network(f"./ng2_networks/ng_sentence_count_{t}.txt", type="default", threshold=t)
    ng_window5_nb.save_network(f"./ng2_networks/ng_window5_count_{t}.txt", type="default", threshold=t)
    ng_window10_nb.save_network(f"./ng2_networks/ng_window10_count_{t}.txt", type="default", threshold=t)

for t in [0.0, 0.35]:
    ng_sentence_nb.save_network(f"./ng2_networks/ng_sentence_npmi_{t}.txt", type="npmi", threshold=t)
    ng_window5_nb.save_network(f"./ng2_networks/ng_window5_npmi_{t}.txt", type="npmi", threshold=t)
    ng_window10_nb.save_network(f"./ng2_networks/ng_window10_npmi_{t}.txt", type="npmi", threshold=t)
...
with open("./ng2_master_object.obj", "wb") as f:
